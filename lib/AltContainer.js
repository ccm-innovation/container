...
var reduceState = function reduceState(props) {
  return (0, _utilsFunctions.assign)({}, getStateFromStores(props), getStateFromActions(props), getInjected(props));
};
...
var AltContainer = (function (_React$Component) {
  ...
  _createClass(AltContainer, [{
    ...
    value: function getProps() {
      ...
      return transform((0, _utilsFunctions.assign)(flux ? { flux: flux } : {}, this.state));
    }
  }, {
    ...
    value: function render() {
      ...
      if (Array.isArray(children)) {
        return _react2['default'].createElement(Node, null, children.map(function (child, i) {
          return _react2['default'].cloneElement(child, (0, _utilsFunctions.assign)({ key: i }, _this3.getProps()));
        }));
      } else if (children) {
